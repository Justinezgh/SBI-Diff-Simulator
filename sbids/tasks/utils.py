...
def get_samples_and_scores(
    ...
    key : jax random seed
    batch_size : size of the batch to sample, by default 64
    score_type : 'density' for nabla_theta log p(theta | y, z) or
                'conditional' for nabla_theta log p(y | z, theta),
                default is 'density'.
    ...
    def log_prob_fn(theta, key):
        ...
        cond_model = condition(cond_model, {'theta': theta})
