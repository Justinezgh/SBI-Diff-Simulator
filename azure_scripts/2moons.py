...
parser.add_argument("--bijector_layers_size", type=int, default=128)
parser.add_argument("--bijector_layers_shape", type=int, default=4)
parser.add_argument("--nf_layers", type=int, default=3)
parser.add_argument("--n_components", type=int, default=16)
parser.add_argument("--score_weight", type=float, default=1e-5)
