...
for comp_nf_layers in [3,4]:
    for normalization_compressor in [15,20,30]:
        for normalization_reg in [0.03,0.04,0.05]:
            for model_seed in range(1):
                for n_simulations in [100000]:
                    ...
                    exp = Experiment(name=f"test_compressor2", workspace=ws)
